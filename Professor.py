...
def proceed():
    ...
    discount=15
    tax=10
    grandtotal=int(((Drinks * 50)+(Coffee * 70)+(Sandwitch * 60)+(Burger * 80))-((Drinks * 50)+(Coffee * 70)+(Sandwitch * 60)+(Burger * 80))*0.15+((Drinks * 50)+(Coffee * 70)+(Sandwitch * 60)+(Burger * 80))*0.1)
